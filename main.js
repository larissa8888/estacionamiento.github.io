...
function add() {
    ...
    greencar_imgTag = new Image(); //define una variable con la imagen nuevae 
	greencar_imgTag.onload = uploadgreencar; // establece la función para cargar esta variable
